class ComentariosController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @comentario.save
        format.html { redirect_to @comentario, notice: "Comentario creado exitosamente." }
  ...
  def update
    respond_to do |format|
      if @comentario.update(comentario_params)
        format.html { redirect_to @comentario, notice: "Comentario actualizado correctamente." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to comentarios_path, status: :see_other, notice: "Comentario eliminado con éxito." }
