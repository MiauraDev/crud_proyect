class CategoriaController < ApplicationController
  ...
  def update
    respond_to do |format|
      if @categorium.update(categorium_params)
        format.html { redirect_to @categorium, notice: "Categoría actualizada correctamente." }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to categoria_path, status: :see_other, notice: "Categoría eliminada con éxito." }
